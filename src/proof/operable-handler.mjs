...
function requestId() {
  return `merge-authority-operable-${randomUUID()}`;
}

async function mintToken(oidcToken) {
...
async function readTargetContent(api) {
...
async function readCanonicalReceipt(api, idempotencyKey) {
...
export async function runMergeAuthorityOperabilityProof(req, res) {
